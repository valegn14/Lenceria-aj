          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {categories.map((cat, idx) => (
              ...
              >
                ...
                <div className="relative h-56 sm:h-64 lg:h-56 w-full">
                  <img
                    src={cat.image}
                    alt={cat.name}
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                  <h3 className="text-xl sm:text-2xl font-serif font-light mb-2 transform transition-transform duration-500 group-hover:translate-y-0">
                    {cat.name}
                  </h3>
                  <p className="text-sm sm:text-base font-light opacity-0 max-h-0 overflow-hidden transition-all duration-500 group-hover:opacity-100 group-hover:max-h-20">
                    {cat.description}
                  </p>
